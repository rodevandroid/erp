    ...
    return new Promise( (resolve, reject) => {
      ...
      try {
        ...
        setTimeout( () => {
          ...
          this.dsCliente = [
            {id: 0, pedido: '0001', cliente: 'Rodrigo Coutinho', vendedor: 'Eder Bolonha', valor: 152325, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 1, pedido: '0002', cliente: 'Eder Bolonha', vendedor: 'Rodrigo Coutinho', valor: 152325, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 2, pedido: '0003', cliente: 'Anderson Rocha', vendedor: 'Bruna Xavier', valor: 152325, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 3, pedido: '0004', cliente: 'Bruna Xavier', vendedor: 'Anderson Rocha', valor: 44035735, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 4, pedido: '0005', cliente: 'Haira Carminati', vendedor: 'Cassiano Ferreira', valor: 55035735, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 5, pedido: '0006', cliente: 'Cassiano Ferreira', vendedor: 'Haira Carminati', valor: 660357.25, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 6, pedido: '0007', cliente: 'Rayssa Melo', vendedor: 'Paulo Machado', valor: 77357.53, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 7, pedido: '0008', cliente: 'Paulo Machado', vendedor: 'Rayssa Melo', valor: 88357.53, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 8, pedido: '0009', cliente: 'Rodrigo Coutinho', vendedor: 'Eder Bolonha', valor: 150357.53, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 9, pedido: '0010', cliente: 'Eder Bolonha', vendedor: 'Rodrigo Coutinho', valor: 220357.53, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 10, pedido: '0011', cliente: 'Anderson Rocha', vendedor: 'Bruna Xavier', valor: 330357.53, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 11, pedido: '0012', cliente: 'Bruna Xavier', vendedor: 'Anderson Rocha', valor: 440357.53, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 12, pedido: '0013', cliente: 'Haira Carminati', vendedor: 'Cassiano Ferreira', valor: 550357.53, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 13, pedido: '0014', cliente: 'Cassiano Ferreira', vendedor: 'Haira Carminati', valor: 660357.25, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 14, pedido: '0015', cliente: 'Rayssa Melo', vendedor: 'Paulo Machado', valor: 77357.72, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 15, pedido: '0016', cliente: 'Paulo Machado', vendedor: 'Rayssa Melo', valor: 88357.72, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 16, pedido: '0017', cliente: 'Rodrigo Coutinho', vendedor: 'Eder Bolonha', valor: 150357.72, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 17, pedido: '0018', cliente: 'Eder Bolonha', vendedor: 'Rodrigo Coutinho', valor: 220357.72, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 18, pedido: '0019', cliente: 'Anderson Rocha', vendedor: 'Bruna Xavier', valor: 330357.72, link: '', process: false, pix: '', qrcode: '', txid: ''},
            {id: 19, pedido: '0020', cliente: 'Bruna Xavier', vendedor: 'Anderson Rocha', valor: 440357.72, link: '', process: false, pix: '', qrcode: '', txid: ''},
